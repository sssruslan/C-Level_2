...
//1. Добавить в программу коллекцию астероидов - Game, строки 20, 177, 259
//Как только она заканчивается (все астероиды сбиты), то формируется новая коллекция, в которой на 1 астероид больше - Game, строка 21, 164
